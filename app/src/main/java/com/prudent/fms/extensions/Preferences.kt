...
/**
 * Created by Dharmik Patel on 19-Jul-17.
 */
...
public fun SharedPreferences.getString(key: String) {
    getString(key,null)
}

public fun SharedPreferences.getInt(key: String) {
    getInt(key,0)
}

public fun SharedPreferences.getBoolean(key: String) {
