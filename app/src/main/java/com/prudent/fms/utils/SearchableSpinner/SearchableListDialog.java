package com.prudent.fms.utils.SearchableSpinner;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    *//*    int width = (getResources().displayMetrics.widthPixels * 0.80).toInt()
        int height = (resources.displayMetrics.heightPixels * 0.70).toInt()*//*

        getDialog().getWindow().setLayout(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
